...
local Movement = library:Window("Movement Hacks")
local Melee = library:Window("Combat")
local Credits = library:Window("Other HACKS")
...
Credits:Label("Kelthston#0541")
Credits:Label("Alnicke GUI")
Credits:Label("Alnicke script + Script Project Hook best")
Credits:Button("Other hacks)", function()
